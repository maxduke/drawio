...
draw.io Ltd is an open source technology stack for building diagramming applications, and the world’s most widely used browser-based end-user diagramming application draw.io.

draw.io Ltd aims to provide free, high quality diagramming software for everyone.

### Purpose

This policy defines the requirements for protecting draw.io Ltd information assets and systems, including physical and digital forms, throughout their lifecycle, to support our people, our customers and processes with a standard approach to managing and addressing information security related threats and events at draw.io Ltd.

### Goals

- Define a simple and structured baseline of security controls to which draw.io Ltd adheres.

### Scope

This policy applies to all personnel, including contractors, of draw.io Ltd and all activities relating to the use, handling, management or control of information assets and systems controlled by draw.io Ltd.

### Roles and Responsibilities

Roles and responsibilities of personnel at draw.io Ltd are proactively identified and assessed, in alignment with the business requirements and information security best practices.

- Personnel of draw.io Ltd follow and operate within all relevant regulations, standards, and legislation, including this standard to ensure the safeguarding of draw.io Ltd information assets.
...
Access to information assets and systems by personnel of draw.io Ltd is proactively identified, managed, and assessed in alignment with applying the principle of least privilege and need to know basis.
...
- Protect draw.io Ltd information assets and systems in accordance with the defined __access control procedure__.
- Identify and provide unique credential sets for each personnel requiring access to draw.io Ltd information assets.
...
Risks associated with employment of personnel of draw.io Ltd are proactively identified and assessed in alignment with ISO/IEC 27001:2013 Annex A, A.7 Human resource security.
...
Operational activities associated with the handling of information are performed in accordance with draw.io Ltd policies and procedures.
...
Suppliers and third-party entities which draw.io Ltd works with and obtains services from are routinely assessed and reviewed for good information security practices to ensure alignment with acceptable information security practices.

- Adhere to the __Third Party Management Policy__.

### Incident Management

The potential dangers of information security incidents and associated events that impact draw.io Ltd or its stakeholders are proactively identified, managed and treated in order to protect draw.io Ltd, its people and stakeholders.
...
Delivery of a business continuity and disaster recovery plan will enable draw.io Ltd to continue operating and enable the business to perform in the event of a severe incident or event.
...
Information assets and systems are routinely audited to confirm compliance with draw.io Ltd Standards, regulatory, legislative and contractual requirements.
...
Remote access provides an effective and secure method of operating and accessing draw.io Ltd information assets and systems.
